...
v6 updates the canon after the post-v5 combat and map-rule discussion.

## Added

- Earth/Moon as realistic/textured protected transit visual exceptions.
- `WEAPONS OFFLINE` protected-corridor transfer pill.
